		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ui5walkthrough-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5walkthrough-display": {
								"semanticObject": "ui5walkthrough",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.walkthrough",
									"url": sap.ui.require.toUrl("ui5/walkthrough")
								}
							}
						}
					}
